...
export default async function ProjectDetailPageServer({params}:{params:Promise<{id:string}>}) {
  ...
  return <ProjectDetailPage project={project.data} profile={profile.data} onSendMessage={createMessageAction}  />;
}
